#
# Be sure to run `pod lib lint ManualLayout.podspec' to ensure this is a
...
#   * Finally, don't worry about the indent, CocoaPods strips it!
  ...
  s.description      = <<-DESC
ManualLayout provides a set of utilities to easily lay out your views in code
                       DESC
  ...
  s.source_files = 'ManualLayout/Classes/**/*'

  # s.resource_bundles = {
  #   'ManualLayout' => ['ManualLayout/Assets/*.png']
  # }
